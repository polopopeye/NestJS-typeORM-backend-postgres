...
y el provider que inicializa el productProvider para que se pueda injectar => PRODUCT_REPOSITORY
...ProductProviders,

Asi se añade un repositorio a un servicio
...
export class ProductsService {
  ...
  findOne(id: number) {
    ...
    const product = this.productRepository.findOne(id); //con repo
    if (!product) {
